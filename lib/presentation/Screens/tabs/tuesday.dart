...
class TuesdayPage extends StatefulWidget {
  ...
  final dynamic data;
  final String day;
  const TuesdayPage({super.key, required this.mode, required this.day, required this.imei,required this.data});
  @override
...
class _TuesdayPageState extends State<TuesdayPage> with AutomaticKeepAliveClientMixin<TuesdayPage>  {
  String deleteDay="";
  String selectDay="";
  // String mode ="normal";
  bool slide=false;
    ...
    MqttService.client.updates!.listen((dynamic t) {
      ...
      if(_topic=='$imei/alarmlist'){
        ...
        if(mode=="normal"){
          Exam narmaldata=all_day.normal;
          if(day=="TUE"){
            log("day message : ${narmaldata.tue}");
            log("day message type : ${narmaldata.tue.runtimeType}");
            log("time: $tt  , sound :: $ss");
            List check_data=narmaldata.tue;
