...
class WednesdayPage extends StatefulWidget {
  ...
  final dynamic data;
  final String day;
  const WednesdayPage({super.key, required this.mode, required this.day, required this.imei,required this.data});
  @override
...
class _WednesdayPageState extends State<WednesdayPage> with AutomaticKeepAliveClientMixin<WednesdayPage>{
  String deleteDay="";
  String selectDay="";
  // String mode ="normal";
  bool slide=false;
    ...
    MqttService.client.updates!.listen((dynamic t) {
      ...
      if(_topic=='$imei/alarmlist'){
        ...
        if(mode=="normal"){
          ...
          if(day=="WED"){
            log("day message : ${narmaldata.wed}");
            log("day message type : ${narmaldata.wed.runtimeType}");
            log("time: $tt  , sound :: $ss");
            List check_data=narmaldata.wed;
