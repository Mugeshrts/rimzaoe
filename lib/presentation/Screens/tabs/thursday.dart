...
class ThursdayPage extends StatefulWidget {
  ...
  final dynamic data;
  final String day;
  const ThursdayPage({super.key, required this.mode, required this.day, required this.imei,required this.data});
  @override
...
class _ThursdayPageState extends State<ThursdayPage> with AutomaticKeepAliveClientMixin<ThursdayPage>{
  String deleteDay="";
  String selectDay="";
  // String mode ="normal";
  bool slide=false;
    ...
    MqttService.client.updates!.listen((dynamic t) {
      ...
      if(_topic=='$imei/alarmlist'){
        ...
        if(mode=="normal"){
          Exam narmaldata=all_day.normal;
          if(day=="THU"){
            log("day message : ${narmaldata.thu}");
            log("day message type : ${narmaldata.thu.runtimeType}");
            log("time: $tt  , sound :: $ss");
            List check_data=narmaldata.thu;
