...
class FridayPage extends StatefulWidget {
  ...
  final dynamic data;
  final String day;
  const FridayPage({super.key, required this.mode, required this.day, required this.imei,required this.data});
  @override
...
class _FridayPageState extends State<FridayPage> with AutomaticKeepAliveClientMixin<FridayPage>{
  String deleteDay="";
  String selectDay="";
  bool slide=false;
  bool api=false;
                        ...
                        SlidableAction(
                          ...
                          onPressed: (value) async{
                            try{
                              ...
                              // Map<String,String> mess={"day":day,"delete":tim.toString()};
    ...
    MqttService.client.updates!.listen((dynamic t) {
      ...
      if(_topic=='$imei/alarmlist'){
        ...
        if(mode=="normal"){
          Exam narmaldata=all_day.normal;
           if(day=="FRI"){
            log("day message : ${narmaldata.fri}");
            log("day message type : ${narmaldata.fri.runtimeType}");
            log("time: $tt  , sound :: $ss");
            List check_data=narmaldata.fri;
