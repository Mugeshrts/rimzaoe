...
class SaturdayPage extends StatefulWidget {
  ...
  final dynamic data;
  final String day;
  const SaturdayPage({super.key, required this.mode, required this.day, required this.imei,required this.data});
  @override
...
class _SaturdayPageState extends State<SaturdayPage> with AutomaticKeepAliveClientMixin<SaturdayPage>{
  String deleteDay="";
  String selectDay="";
  // String mode ="normal";
  bool slide=false;
    ...
    MqttService.client.updates!.listen((dynamic t) {
      ...
      if(_topic=='$imei/alarmlist'){
        ...
        if(mode=="normal"){
          Exam narmaldata=all_day.normal;
          if(day=="SAT"){
            log("day message : ${narmaldata.sat}");
            log("day message type : ${narmaldata.sat.runtimeType}");
            log("time: $tt  , sound :: $ss");
            List check_data=narmaldata.sat;
